...
- [`core-picture.md`](core-picture.md) — the short shared picture: ear, mouth, lab, one GPU occupant, leftover hop, two clocks, leftover hop vs generate, reference on every segment, stop vs cancel, take.
