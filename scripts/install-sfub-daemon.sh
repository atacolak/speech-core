...
vad_acoustic_fallback_silence_ms="${SPEECH_CORE_VAD_ACOUSTIC_FALLBACK_SILENCE_MS:-1700}"
...
turn_human_hold_silence_ms="${SPEECH_CORE_TURN_HUMAN_HOLD_SILENCE_MS:-7000}"
